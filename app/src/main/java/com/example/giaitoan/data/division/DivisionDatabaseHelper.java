package com.example.giaitoan.data.division;
...
public class DivisionDatabaseHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "Division.db";
    ...
    public DivisionDatabaseHelper(Context context) {
