...
public class PracticeDatabaseHelper extends SQLiteOpenHelper {
    ...
    public QuestionPra getRandomQuestionAndAnswersExcept(HashSet<Integer> excludedIds) {
        ...
        Cursor cursor = db.query(TABLE_QUESTIONS, columns, COLUMN_ID + " NOT IN (" + excludedIdsString + ")", null, null, null, "RANDOM()", "1");
        ...
        if (cursor.moveToFirst()) {
            ...
            question = new QuestionPra(id,x, pt, y, z, new ArrayList<>(answers), correctAnswer);
        }
