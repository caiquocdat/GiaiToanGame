package com.caiquocdat.giaitoan.data.practice;
...
public class DataPracticeSetup {
    ...
    public void setUpDataPra() {
        ...
        QuestionPra questionPra_10 = new QuestionPra(
                10,99,null,9,11,answer_10,":"
        );
        List<String> answer_11= new ArrayList<>();
        answer_11.add("+");
        answer_11.add("-");
        answer_11.add("x");
        answer_11.add(":");
        QuestionPra questionPra_11 = new QuestionPra(
                11,92,null,4,23,answer_11,":"
        );
        List<String> answer_12= new ArrayList<>();
        answer_12.add("+");
        answer_12.add("-");
        answer_12.add("x");
        answer_12.add(":");
        QuestionPra questionPra_12 = new QuestionPra(
                12,79,null,60,9,answer_12,"-"
        );
        ...
        questionPraList.add(questionPra_11);
        questionPraList.add(questionPra_12);
