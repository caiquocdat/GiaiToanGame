package com.caiquocdat.giaitoan.data.multiplication;
...
public class DataMultiplicationPlusSetup {
    private Context context;

    public DataMultiplicationPlusSetup(Context context) {
        this.context = context;
    }
    public void setUpDataPlus() {
        // câu hỏi 1
        QuestionModel questionModel_1= new QuestionModel(1,"2 x 1","2");
        ...
        // câu hỏi 2
        QuestionModel questionModel_2= new QuestionModel(2,"2 x 4","8");
        ...
        // câu hỏi 3
        QuestionModel questionModel_3= new QuestionModel(3,"43 x 2","86");
        AnswerModel answerModel3_1= new AnswerModel(13,3,"86");
        AnswerModel answerModel3_2= new AnswerModel(14,3,"92");
        AnswerModel answerModel3_3= new AnswerModel(15,3,"17");
        AnswerModel answerModel3_4= new AnswerModel(16,3,"14");
        AnswerModel answerModel3_5= new AnswerModel(17,3,"33");
        AnswerModel answerModel3_6= new AnswerModel(18,3,"15");
        ...
        // câu hỏi 5
        QuestionModel questionModel_5= new QuestionModel(5,"33 x 3","99");
        AnswerModel answerModel5_1= new AnswerModel(25,5,"98");
        AnswerModel answerModel5_2= new AnswerModel(26,5,"28");
        AnswerModel answerModel5_3= new AnswerModel(27,5,"97");
        AnswerModel answerModel5_4= new AnswerModel(28,5,"71");
        AnswerModel answerModel5_5= new AnswerModel(29,5,"99");
        AnswerModel answerModel5_6= new AnswerModel(30,5,"91");
        ...
        // câu hỏi 6
        QuestionModel questionModel_6= new QuestionModel(6,"5 x 7","35");
        AnswerModel answerModel6_1= new AnswerModel(31,6,"35");
        AnswerModel answerModel6_2= new AnswerModel(32,6,"12");
        AnswerModel answerModel6_3= new AnswerModel(33,6,"73");
        ...
        // câu hỏi 7
        QuestionModel questionModel_7= new QuestionModel(7,"8 x 6","48");
        ...
        AnswerModel answerModel7_4= new AnswerModel(40,7,"48");
        ...
        // câu hỏi 8
        QuestionModel questionModel_8= new QuestionModel(8,"7 x 9","63");
        ...
        AnswerModel answerModel8_4= new AnswerModel(46,8,"91");
        AnswerModel answerModel8_5= new AnswerModel(47,8,"63");
        ...
        // câu hỏi 9
        QuestionModel questionModel_9= new QuestionModel(9,"22 x 2","44");
        AnswerModel answerModel9_1= new AnswerModel(49,9,"44");
        ...
        // câu hỏi 10
        QuestionModel questionModel_10= new QuestionModel(10,"8 x 4","32");
        ...
        //câu hỏi 11
        QuestionModel questionModel_11= new QuestionModel(11,"9 x 11","99");
        ...
        AnswerModel answerModel11_6= new AnswerModel(66,11,"99");
        ...
        // câu hỏi 12
        QuestionModel questionModel_12= new QuestionModel(12,"9 x 9","81");
        ...
        AnswerModel answerModel12_6= new AnswerModel(72,12,"81");
        ...
        MultiplicationDatabaseHelper multiplicationDatabaseHelper= new MultiplicationDatabaseHelper(context);
        multiplicationDatabaseHelper.addQuestionsWithAnswers(withAnswersModelList);
    }
}
