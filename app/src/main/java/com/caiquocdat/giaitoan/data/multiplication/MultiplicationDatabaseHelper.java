...
public class MultiplicationDatabaseHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "Multiplication.db";
    ...
    public MultiplicationDatabaseHelper(Context context) {
