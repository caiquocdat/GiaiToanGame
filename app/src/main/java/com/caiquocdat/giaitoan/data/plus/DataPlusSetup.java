package com.caiquocdat.giaitoan.data.plus;
...
public class DataPlusSetup {
    private Context context;

    public DataPlusSetup(Context context) {
        this.context = context;
    }
    public void setUpDataPlus() {
        // câu hỏi 1
        QuestionModel questionModel_1= new QuestionModel(1,"1 + 1","2");
        ...
        // câu hỏi 2
        QuestionModel questionModel_2= new QuestionModel(2,"3 + 5","8");
        ...
        // câu hỏi 3
        QuestionModel questionModel_3= new QuestionModel(3,"6 + 1","7");
        ...
        // câu hỏi 4
        QuestionModel questionModel_4= new QuestionModel(4,"4 + 2","6");
        ...
        // câu hỏi 5
        QuestionModel questionModel_5= new QuestionModel(5,"9 + 8","17");
        ...
        // câu hỏi 6
        QuestionModel questionModel_6= new QuestionModel(6,"10 + 2","12");
        ...
        // câu hỏi 7
        QuestionModel questionModel_7= new QuestionModel(7,"8 + 6","14");
        ...
        // câu hỏi 8
        QuestionModel questionModel_8= new QuestionModel(8,"7 + 15","22");
        ...
        // câu hỏi 9
        QuestionModel questionModel_9= new QuestionModel(9,"2 + 9","11");
        ...
        // câu hỏi 10
        QuestionModel questionModel_10= new QuestionModel(10,"8 + 19","27");
        ...
        //câu hỏi 11
        QuestionModel questionModel_11= new QuestionModel(11,"20 + 39","59");
        ...
        // câu hỏi 12
        QuestionModel questionModel_12= new QuestionModel(12,"39 + 17","56");
        ...
        PlusDatabaseHelper plusDatabaseHelper= new PlusDatabaseHelper(context);
